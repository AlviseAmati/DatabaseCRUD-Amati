...
if(isset($_GET['SELECT']))
{
    ...
    if (mysqli_num_rows($result) > 0) {
        while($row = mysqli_fetch_assoc($result)) {
            echo "id: " . $row["id"]. "   Nome: " . $row["nome"]. "   Cognome " . $row["cognome"]. "  email". $row["email"]. "  Telefono". $row["numeroditelefono"]. "  Indirizzo". $row["indirizzo"]. "  Città". $row["citta"]. "  CAP". $row["CAP"]. "  C.Fiscale". $row["CodiceFiscale"]. "<br>";
        }
    } else {
        echo "0 results";
    }
